 ...
 * 4. Construct request to take story from the the design phase and mark it as complete
...
async function main() {
  ...
  try {
    ...
    console.log('Complete Story transaction.');

    const designResponse = await contract.submitTransaction('complete', 'BackLog', '00001', 'balaji', 'build-123');
    ...
    console.log(`${story.storyType} story : ${story.storyNumber} successfully included in build ${story.owner} marking as complete`);
